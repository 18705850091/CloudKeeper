  ...
  <div class="login-body">
    ...
    <div class="login-panel">
      <el-form
        ...
        @submit.prevent
      >
        <div class="login-title">CloudKeeper</div>
        <!--input输入-->
        ...
        <div class="login-bt-qq" v-if="opType==1">
                快捷登录<img src="@/assets/qq.png" @click="qqLogin" style="height: 25px;width: auto;" />
        </div>
      </el-form>
    </div>
  </div>
...
const checkRePassword = (rule, value, callback) => {
  if (value !== formData.value.registerPassword) {
    callback(new Error(ruel.message));
  } else {
    callback();
  }
};
...
.login-body {
  ...
  background-color: rgb(137, 200, 234);
  display: flex;
